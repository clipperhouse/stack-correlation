...
(function() {
  ...
  $(function() {
    var api_key, changeState, getcorrelations, getmenuitem, getsite, getsites, gettag, menu, pushState, round, site_current, site_name, tag_correlations, tag_count, tag_input, urls;
    menu = $("#sites");
    tag_count = $("#tag-count");
    site_name = $("#site-name");
    ...
    return changeState = function(site, tag) {
      site_current = site || getsite("stackoverflow");

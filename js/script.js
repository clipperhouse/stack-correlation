  ...
  $(function() {
    ...
    urls = {
      api_sites: function(page) {
        return "http://api.stackexchange.com/2.2/sites?page=" + page + "&pagesize=100&filter=!0U12eE-l6vTXjGb9hog*DtBLF&key=" + api_key;
      },
      api_tags: function(site, tag) {
        return "http://api.stackexchange.com/2.2/tags?pagesize=16&order=desc&sort=popular&inname=" + (encodeURIComponent(tag)) + "&site=" + site.api_site_parameter + "&filter=!*M27MxijjqVg4jGo&key=" + api_key;
      },
      api_tag_count: function(site, tag) {
        return "http://api.stackexchange.com/2.2/questions?order=desc&sort=activity&tagged=" + (encodeURIComponent(tag)) + "&site=" + site.api_site_parameter + "&filter=!LQa0AXyWeCS0eBBhfz)UnE&key=" + api_key;
      },
      api_tags_related: function(site, tag) {
        return "http://api.stackexchange.com/2.2/tags/" + (encodeURIComponent(tag)) + "/related?site=" + site.api_site_parameter + "&key=" + api_key + "&filter=!n9Z4Y*b7KJ";
      }
    };
    ...
    return setTimeout(function() {
      if (location.hash.length <= 1) {
        return pushState(getsite("stackoverflow"));
      } else {
        return pop();
      }
    }, 200);
